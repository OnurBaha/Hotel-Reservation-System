...
function About() {
  return (
    <div className="animate-fade-in relative">
      ...
      <div className="about-hero-container">
        ...
        <div className="about-hero-overlay">
          <div className="about-title-wrapper-hero">
            ...
            <h1 className="about-title-hero">Hakkımızda</h1>
      ...
      {/* İçerik Kartı */}
      <div className="about-content-card-overlay max-w-4xl mx-auto px-6 py-12 relative z-10 -mt-20">
