          ...
          <div className="contact-modal-overlay">
            <div className="contact-modal-content">
              ...
              <p className="contact-modal-desc">
                Bizimle iletişime geçtiğiniz için teşekkür ederiz. Ekibimiz en
                kısa sürede tarafınıza dönüş yapacaktır.
              </p>
              <button
        ...
        <div className="contact-hero-overlay">
          <div className="contact-hero-content">
            ...
            <p className="contact-hero-desc">
              Sorularınız, rezervasyon talepleriniz veya iş başvurularınız için
              bizimle iletişime geçmekten çekinmeyin. Size yardımcı olmaktan
              memnuniyet duyarız.
            </p>
        ...
        <div className="contact-cards-grid">
          <div className="contact-info-card">
            ...
            <p className="contact-card-desc">
              Oda ayırtmak için bizimle e-posta üzerinden iletişime
              geçebilirsiniz.
            </p>
            <a
              href="mailto:reservations@luxevista.com"
              className="contact-card-link"
            >
              reservations@luxevista.com
            </a>
          </div>
          ...
          <div className="contact-info-card">
            ...
            <p className="contact-card-desc">
              Genel sorularınız için bize yazmaktan çekinmeyin.
            </p>
            <a href="mailto:info@luxevista.com" className="contact-card-link">
              info@luxevista.com
            </a>
          </div>
          ...
          <div className="contact-info-card">
            ...
            <p className="contact-card-desc">
              Kariyer fırsatlarını değerlendirmek için CV'nizi bekliyoruz.
            </p>
            <a
              href="mailto:careers@luxevista.com"
              className="contact-card-link"
            >
              careers@luxevista.com
            </a>
          </div>
        </div>
            ...
            <div className="contact-map-side">
              ...
              <div className="contact-address-box">
                ...
                <p className="contact-address-text">
                  123 Coastal Drive, Antalya, Türkiye
                </p>
              </div>
            </div>
